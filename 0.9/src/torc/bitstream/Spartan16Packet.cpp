...
/// \file
/// \brief Source for the Spartan16Packet class.
...
namespace bitstream {
	...
	const char* Spartan16Packet::sPacketTypeName[ePacketTypeCount] = {
		"[UNKNOWN TYPE 0]", "TYPE1", "TYPE2", "[UNKNOWN TYPE 3]", "[UNKNOWN TYPE 4]", 
		"[UNKNOWN TYPE 5]", "[UNKNOWN TYPE 6]", "[UNKNOWN TYPE 7]"
	};

	const char* Spartan16Packet::sOpcodeName[eOpcodeCount] = {
