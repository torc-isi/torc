...
#ifndef TORC_GENERIC_OM_INTERFACEJOINEDINFO_HPP
#define TORC_GENERIC_OM_INTERFACEJOINEDINFO_HPP
...
class InterfaceJoinedInfo : 
    public Visitable,
    public SelfReferencing<InterfaceJoinedInfo> 
{
  ...
  public:
    ...
    class Factory: public FactoryType<InterfaceJoinedInfo>
    {
         ...
         */
         ...
         virtual newInterfaceJoinedInfoPtr( const std::list< PortSharedPtr > & inPorts,
                const std::list< PortListSharedPtr > & inPortLists,
                const ViewSharedPtr & inViewPtr,
                const InterfaceJoinedInfoSharedPtr & inParentJoinedInfo
                        = InterfaceJoinedInfoSharedPtr() ) throw(Error);
    };
     ...
     */
    inline const JoinedType 
    getJoinedType() const throw();
     ...
     */
    void 
    setJoinedType( const JoinedType & inSource ) throw();
    ...
    */
     ...
     */
    inline void
    getPorts( std::list< PortSharedPtr > & outPorts ) const throw();
     ...
     */
    void 
    setPorts( const std::list< PortSharedPtr > & inSource ) throw();
    ...
    */
    void
    addPortList( const PortListSharedPtr & inPortList ) throw();
     ...
     */
    inline void
    getPortLists( std::list< PortListSharedPtr > & outPortLists) const throw();
     ...
     */
    void 
    setPortLists( const std::list< PortListSharedPtr > & inSource ) throw();
     ...
     */
    inline void
    getChildren( std::vector< InterfaceJoinedInfoSharedPtr >
            & outJoinedInfos ) const throw();
     ...
     */
    void 
    setChildren(const std::vector< InterfaceJoinedInfoSharedPtr > 
            & inSource) throw();
    ...
    bool 
    addChildJoinedInfo( 
            const InterfaceJoinedInfoSharedPtr & inChildJoinInfo) throw();
 ...
 * @return Interface joining type
 */
inline const InterfaceJoinedInfo::JoinedType 
InterfaceJoinedInfo::getJoinedType() const throw() {
    return mJoinedType;
}
 ...
 */
inline void
InterfaceJoinedInfo::getPorts( 
            std::list< PortSharedPtr > & outPorts ) const throw() {
    outPorts.insert( outPorts.end(),
            mJoinedPorts.begin(), mJoinedPorts.end() );
}
 ...
 */
inline void
InterfaceJoinedInfo::getPortLists( 
            std::list< PortListSharedPtr > & outPortLists ) const throw() {
    outPortLists.insert( outPortLists.end(), 
                mJoinedPortLists.begin(), mJoinedPortLists.end() );
}
 ...
 */
inline void
InterfaceJoinedInfo::getChildren( std::vector< InterfaceJoinedInfoSharedPtr >
        & outJoinedInfos ) const throw() {
...
template<typename _Action> 
inline void 
InterfaceJoinedInfo::applyOnAllChildren(const _Action & action) throw(Error) {
    try
    {
 ...
 * @return RelationType
 */
inline const InterfaceJoinedInfo::RelationType
InterfaceJoinedInfo::getRelationType() const throw() {
...
#endif // TORC_GENERIC_OM_INTERFACEJOINEDINFO_HPP
