 ...
 */
ForbiddenEventSharedPtr ForbiddenEvent::Factory::newForbiddenEventPtr(
...
void ForbiddenEvent::accept(BaseVisitor& inoutVisitor) throw (Error) {
	try {
 ...
 */
void ForbiddenEvent::setStartTimeInterval(const EventSharedPtr& inSource) {
 ...
 */
void ForbiddenEvent::setEndTimeInterval(const EventSharedPtr& inSource) {
 ...
 */
void ForbiddenEvent::setDuration(const Value& inValue) {
	mDuration = inValue;
}
 ...
 */
void ForbiddenEvent::setEvents(const std::list<EventSharedPtr>& inEvents) {
 ...
 */
void ForbiddenEvent::addEvent(const EventSharedPtr& inSource) {
	try {
...
ForbiddenEvent::ForbiddenEvent() : Visitable(), SelfReferencing<ForbiddenEvent>(),
	mStartTimeInterval(), mEndTimeInterval(), mDuration(), mEvents() {}
