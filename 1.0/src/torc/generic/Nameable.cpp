 ...
 */
void Nameable::setName(const std::string& inSource) throw (Error) {
	if(inSource.empty()) {
...
#ifdef GENOM_SERIALIZATION
template <class Archive> void Nameable::serialize(Archive& ar, unsigned int) {
	ar & mName;
}

//TO SATISFY THE LINKER
template void Nameable::serialize<boost::archive::binary_iarchive>(
	boost::archive::binary_iarchive& ar, const unsigned int);

template void Nameable::serialize<boost::archive::binary_oarchive>(
