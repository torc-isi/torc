...
#ifndef TORC_GENERIC_VECTORPORTREFERENCE_HPP
#define TORC_GENERIC_VECTORPORTREFERENCE_HPP
 ...
 */
class VectorPortReference : public PortReference, public Vector<PortReference,
	VectorPortBitReference, VectorPortBitReference::Factory, true> {
#ifdef GENOM_SERIALIZATION
...
public:
	typedef Vector<PortReference, VectorPortBitReference, VectorPortBitReference::Factory, true>
		BaseType;
	...
	public:
		 ...
		 **/
		virtual VectorPortReferenceSharedPtr newVectorPortReferencePtr(
			const InstanceSharedPtr& inInstancePtr, const PortSharedPtr& inPortPtr,
			const size_t& inSize, const PortBundleReferenceSharedPtr& inParentCollection
				= PortBundleReferenceSharedPtr(), const ChildFactorySharedPtr& inFactory
				= BaseType::ChildFactorySharedPtr(new BaseType::ChildFactory())) throw (Error);
		 ...
		 **/
		virtual VectorPortReferenceSharedPtr newVectorPortReferencePtr(
			const InstanceSharedPtr& inInstancePtr,
			...
			const ChildFactorySharedPtr& inFactory
				= BaseType::ChildFactorySharedPtr(new BaseType::ChildFactory())
		) throw (Error);
	 ...
	 * @param[in] inSkipChildConnections bool Whether child connection is skipped or not
	 */
...
#endif // TORC_GENERIC_VECTORPORTREFERENCE_HPP
