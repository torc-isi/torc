...
Linker::NameSpec::operator=(
                    const Linker::NameSpec& inSource) {
    if(this != &inSource)
    {
        mLibraryName = inSource.mLibraryName;
        mCellName = inSource.mCellName;
...
void
Linker::NameSpec::setCellName(const std::string& inValue) {
  mCellName = inValue;
}

void
Linker::NameSpec::setViewName(const std::string& inValue) {
  mViewName = inValue;
}

void
Linker::UnresolvedInstances::setExternView(
                const ViewSharedPtr& inValue) {
  mExternView = inValue;
}
