...
void 
InterfaceAttributes::setDesignator(const std::string & inSource) throw() {
 ...
 */
void
InterfaceAttributes::setSimulate(const SimulateSharedPtr & inSource ) throw() {
    mSimulate = inSource;
}
 ...
 */
void
InterfaceAttributes::setTiming(const TimingSharedPtr & inSource ) throw() {
    mTiming = inSource;
}
