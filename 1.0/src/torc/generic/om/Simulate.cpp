 ...
 */
SimulateSharedPtr
Simulate::Factory::newSimulatePtr( const std::string & inName,
        ...
        const std::string & inOriginalName,
        const InterfaceAttributesSharedPtr & inInterfaceAttributes ) throw(Error) {
    try
    {
...
void
Simulate::accept(BaseVisitor & inoutVisitor) throw(Error) {
    try
    {
 ...
 */
void 
Simulate::addPortListAlias(const PortListAliasSharedPtr & inPortListAlias) throw(Error) {
    if( !inPortListAlias )
    {
        return;
    }
...
Simulate::findPortListAlias(const std::string & inName) throw() {
    if( inName.empty() )
    {
        Error e( eMessageIdErrorEmptyItemName,
            __FUNCTION__, __FILE__, __LINE__ );
 ...
 */
void 
Simulate::addApply( const ApplySharedPtr & inSource) throw(Error) {
    try
    {
 ...
 */
void 
Simulate::setAllApply( const std::vector< ApplySharedPtr > & inAllApply ) throw(Error) {
 ...
 */
void 
Simulate::setWaveValues( 
        const std::vector< WaveValueSharedPtr > & inWaveValues ) throw(Error) {
 ...
 */
void 
Simulate::addWaveValue( const WaveValueSharedPtr & inSource ) throw(Error) {
    if( !inSource )
    {
        return;
    }
 ...
 */
WaveValueSharedPtr 
Simulate::findWaveValue(const std::string & inName) throw() {
    if( inName.empty() )
    {
        Error e( eMessageIdErrorEmptyItemName,
            __FUNCTION__, __FILE__, __LINE__ );
