...
#ifndef TORC_GENERIC_PORTLIST_HPP
#define TORC_GENERIC_PORTLIST_HPP
...
class PortList : public Connectable, public SelfReferencing<PortList> {
...
public:
	...
	public:
		 ...
		 */
		virtual PortListSharedPtr newPortListPtr(const std::list<PortSharedPtr>& inPorts,
...
private:
	template <typename _Tp> void connectElementToNet(const NetSharedPtr& inNet,
...
#endif // TORC_GENERIC_PORTLIST_HPP
