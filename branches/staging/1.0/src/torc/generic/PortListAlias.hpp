...
#ifndef TORC_GENERIC_PORTLISTALIAS_HPP
#define TORC_GENERIC_PORTLISTALIAS_HPP
...
class PortListAlias : public Nameable, public SelfReferencing<PortListAlias> {
...
public:
	...
	public:
		 ...
		 **/
		virtual PortListAliasSharedPtr newPortListAliasPtr(const std::string& inName,
			const PortListSharedPtr& inPortList, const SimulateSharedPtr& inSimulate =
...
inline const PortListSharedPtr PortListAlias::getPortList() const {
	return mPortList;
}
...
#endif // TORC_GENERIC_PORTLISTALIAS_HPP
