...
#ifndef TORC_GENERIC_SINGLEPARAMETER_HPP
#define TORC_GENERIC_SINGLEPARAMETER_HPP
 ...
 */
class SingleParameter : public Parameter, public Scalar<Parameter> {
#ifdef GENOM_SERIALIZATION
...
public:
	...
	public:
		 ...
		 */
		virtual SingleParameterSharedPtr newSingleParameterPtr(const std::string& inName,
			const Value& inValue, const Unit& inUnit = eUnitUndefined,
...
#endif // TORC_GENERIC_SINGLEPARAMETER_HPP
