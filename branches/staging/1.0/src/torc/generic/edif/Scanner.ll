...
void
Scanner::setAppendToBuffer(bool inAppendToBuffer) {
...
void
Scanner::setAppendToUserDataBuffer(bool inAppendToBuffer) {
	mAppendToUserDataBuffer = inAppendToBuffer;
}

void
Scanner::resetUserDataBuffer() {
	mUserDataBuffer = "";
}

void
Scanner::addToBuffer(const char *str) {
...
void
Scanner::addToUserDataBuffer(const char *str) {
