 ...
 */
ApplySharedPtr
Apply::Factory::newApplyPtr( const int32_t & inNoOfCycle,
...
void
Apply::accept(BaseVisitor & inoutVisitor) throw(Error) {
    try
    {
 ...
 */
void 
Apply::setNoOfCycle( const int32_t & inValue ) throw() {
    mNoOfCycle = inValue;
}
 ...
 */
void 
Apply::setCycleDuration(const Value & value) throw() {
 ...
 */
void
Apply::setLogicResponses( 
        const std::list< LogicalResponseSharedPtr > & inLogicResponces ) throw() {
    std::list< LogicalResponseSharedPtr >::const_iterator 
                logicalResponse = inLogicResponces.begin();
 ...
 */
void 
Apply::addLogicResponse(
        const LogicalResponseSharedPtr & inLogicResponce ) throw() {
    try
    {
