 ...
 **/
ScalarPortReferenceSharedPtr ScalarPortReference::Factory::newScalarPortReferencePtr(
...
void ScalarPortReference::accept(BaseVisitor& inoutVisitor) throw (Error) {
	try {
...
Connectable::Connection ScalarPortReference::connect(const NetSharedPtr& inNet) throw (Error) {
	if(!inNet) {
...
void ScalarPortReference::disconnect(const Connection& inConnection) throw (Error) {
...
ScalarPortReference::ScalarPortReference() : PortReference(), Scalar<PortReference>() {}

ScalarPortReference::~ScalarPortReference() throw () {}

#ifdef GENOM_SERIALIZATION
template <class Archive> void ScalarPortReference::serialize(Archive& ar, unsigned int) {
...
template void ScalarPortReference::serialize<boost::archive::binary_iarchive>(
	boost::archive::binary_iarchive& ar, const unsigned int);

template void ScalarPortReference::serialize<boost::archive::binary_oarchive>(
