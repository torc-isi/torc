...
#ifndef TORC_GENERIC_OM_SIMULATIONINFO_HPP
#define TORC_GENERIC_OM_SIMULATIONINFO_HPP
...
class SimulationInfo : 
    ...
    public SelfReferencing<SimulationInfo>,
  ...
  public:
     ...
     */
    void 
    addLogicValue(const LogicValueSharedPtr & inLogicValue) throw(Error);
     ...
     */
    LogicValueSharedPtr 
    findLogicValue(const std::string & inName) throw();
     ...
     */
    void
    removeLogicValue(const std::string &inName) throw(Error);
    ...
    inline void 
    getLogicValues(
        std::vector< LogicValueSharedPtr > & outLogicValues) const throw();
    ...
    void 
    setLogicValues(
        const std::vector< LogicValueSharedPtr > & inLogicValues) throw(Error);
    ...
    */
    ...
    inline void
    applyOnAllLogicValues( const _Action &action ) throw(Error);

    virtual
    ~SimulationInfo() throw();
  ...
  private:
    ...
    SimulationInfo & 
    operator=(const SimulationInfo & source) throw();
...
template<typename _Action>
inline void
SimulationInfo::applyOnAllLogicValues( const _Action &action ) throw(Error) {
    try
    {
...
#endif // TORC_GENERIC_OM_SIMULATIONINFO_HPP
