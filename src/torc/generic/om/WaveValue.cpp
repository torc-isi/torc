 ...
 */
WaveValueSharedPtr
WaveValue::Factory::newWaveValuePtr( const std::string & inName,
...
void
WaveValue::accept(BaseVisitor & inoutVisitor) throw(Error) {
    try
    {
 ...
 */
void 
WaveValue::setDeltaTimeDuration( const Value & value ) throw() {
 ...
 */
void 
WaveValue::setLogicWaveform(const LogicElementSharedPtr & inSource) throw() {
