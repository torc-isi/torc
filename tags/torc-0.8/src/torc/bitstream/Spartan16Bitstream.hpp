...
/// \file
/// \brief Header for the Spartan16Bitstream class.
...
namespace bitstream { class bitstream_spartan16_bitstream; }
	...
	class Spartan16Bitstream : public Bitstream, public Spartan16PacketVector, 
		public Spartan16PacketConstants {
	...
	// constructors
		...
		Spartan16Bitstream(void) : Bitstream(), Spartan16PacketVector(), Spartan16PacketConstants() {}
	// functions
