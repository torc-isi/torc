...
//#define GENERATE_STATIC_DEVICE_INFO
	...
	VirtexFrameBlocks Virtex2::getBitstreamFrames (uint32_t blockCount, uint32_t bitCol) {
	...
	VirtexFrameBlocks Virtex2::getXdlFrames (uint32_t blockCount, uint32_t xdlCol) {
