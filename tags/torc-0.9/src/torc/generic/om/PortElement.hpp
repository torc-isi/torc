...
#ifndef TORC_GENERIC_OM_PORTELEMENT_HPP
#define TORC_GENERIC_OM_PORTELEMENT_HPP
...
class PortElement {
  public:
     ...
     */
    void
    setType( const ElementType & inSource ) throw();
     ...
     */
    inline const PortReferenceSharedPtr
    ...
    PortElement &
    operator =( const PortElement &inRhs );
...
inline const PortElement::ElementType
PortElement::getType() const throw() {
    return mType;
}

inline const PortSharedPtr
PortElement::getPort() const throw() {
    return mPort;
}

inline const PortReferenceSharedPtr
PortElement::getPortReference() const throw() {
...
#endif // TORC_GENERIC_OM_PORTELEMENT_HPP
