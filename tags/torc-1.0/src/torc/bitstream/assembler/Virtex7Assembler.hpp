...
#ifndef TORC_BITSTREAM_ASSEMBLER_VIRTEX7ASSEMBLER_HPP
#define TORC_BITSTREAM_ASSEMBLER_VIRTEX7ASSEMBLER_HPP

#include "torc/bitstream/Virtex7.hpp"
#include "VirtexAssembler.hpp"
#include "torc/Physical.hpp"
#include "torc/architecture/DDB.hpp"
#include "build/AssemblerLibGen.hpp"
#include "build/Virtex7LibGen.hpp"

namespace torc {
namespace bitstream {

class Virtex7Assembler: public VirtexAssembler {
public:
	// Constructor
...
protected:
	void initialize(void) {
		...
		mCompoundSettingMap = torc::bitstream::Virtex7LibGen::getCompoundSettingsMap();
		mParentFamilyName = "Virtex7";
	...
	virtual void initializeFullFrameBlocks() {
		torc::bitstream::Virtex7 *virtexBitStream =
				dynamic_cast<torc::bitstream::Virtex7 *> (mBitstreamPtr.get());
	...
	virtual uint32_t getPrimaryXdlColumn(TileCol inTileColumn) {
		torc::bitstream::Virtex7 *virtex7Bitstream =
				dynamic_cast<torc::bitstream::Virtex7 *> (mBitstreamPtr.get());
		return virtex7Bitstream->getPrimaryXdlColumn(0, inTileColumn);
	}
	...
	virtual torc::bitstream::VirtexFrameBlocks getXdlFrames(TileRow inTileRow,
		...
		torc::bitstream::Virtex7 *virtex7Bitstream =
				dynamic_cast<torc::bitstream::Virtex7 *> (mBitstreamPtr.get());
		return virtex7Bitstream->getXdlFrames(inTileRow, inPrimaryXdlCol, inBitIndexBegin,
				inBitIndexEnd, torc::bitstream::Bitstream::eBlockTypeCount);
	}
...
#endif // TORC_BITSTREAM_ASSEMBLER_VIRTEX7ASSEMBLER_HPP
