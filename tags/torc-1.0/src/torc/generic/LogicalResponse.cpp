 ...
 */
LogicalResponseSharedPtr LogicalResponse::Factory::newLogicalResponsePtr(
	const ResponseType& inResponseType, const PortSharedPtr& inPort,
	const LogicElementSharedPtr& inLogicWaveForm, const PortListAliasSharedPtr& inPortListAlias)
		throw (Error) {
	try {
...
void LogicalResponse::accept(BaseVisitor& inoutVisitor) throw (Error) {
	try {
 ...
 */
void LogicalResponse::setResponseType(const ResponseType& inSource) {
 ...
 */
void LogicalResponse::setConnectedPort(const PortSharedPtr& inPort) {
 ...
 */
void LogicalResponse::setConnectedPortList(const PortListSharedPtr& inPortList) {
 ...
 */
void LogicalResponse::setConnectedPortListAlias(const PortListAliasSharedPtr& inPortListAlias) {
 ...
 */
void LogicalResponse::setLogicWaveForm(const LogicElementSharedPtr& inSource) {
	mLogicWaveForm = inSource;
}

LogicalResponse::LogicalResponse() : Visitable(), SelfReferencing<LogicalResponse>(),
	mResponseType(), mConnectedPort(), mConnectedPortList(), mConnectedPortListAlias(),
	mLogicWaveForm() {}
