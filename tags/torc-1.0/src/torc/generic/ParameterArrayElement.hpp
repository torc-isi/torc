...
#ifndef TORC_GENERIC_PARAMETERARRAYELEMENT_HPP
#define TORC_GENERIC_PARAMETERARRAYELEMENT_HPP
 ...
 */
class ParameterArrayElement : public Parameter, public VectorBit<Parameter> {
#ifdef GENOM_SERIALIZATION
...
public:
	...
	virtual ~ParameterArrayElement() throw ();
...
#endif // TORC_GENERIC_PARAMETERARRAYELEMENT_HPP
