...
#ifndef TORC_GENERIC_SIMULATE_HPP
#define TORC_GENERIC_SIMULATE_HPP
 ...
 * contents of views.
 */
class Simulate : public Nameable, public Renamable, public Commentable, public Visitable,
	public SelfReferencing<Simulate>, public UserDataContainer {
...
public:
	...
	public:
		 ...
		 */
		SimulateSharedPtr virtual newSimulatePtr(const std::string& inName,
	 ...
	 */
	inline void getPortListAliases(std::vector<PortListAliasSharedPtr>& outPortListAliases) const;
	 ...
	 */
	inline void getAllApply(std::vector<ApplySharedPtr>& outAllApply) const;
	 ...
	 */
	inline void getWaveValues(std::vector<WaveValueSharedPtr>& outWaveValues) const;
	 ...
	 *
	 */
	template <typename _Action> inline void applyOnAllPortListAlias(const _Action& action)
		throw (Error);
	 ...
	 *
	 */
	template <typename _Action> inline void applyOnAllWaveValues(const _Action& action)
		throw (Error);
 ...
 * @param[out] outPortListAliases Vector of PortListAlias to be appended to
 */
inline void Simulate::getPortListAliases(
	std::vector<PortListAliasSharedPtr>& outPortListAliases) const {
 ...
 * @param[out] outAllApply Vector of apply objects to be appended to
 */
inline void Simulate::getAllApply(std::vector<ApplySharedPtr>& outAllApply) const {
	outAllApply.insert(outAllApply.end(), mAllApply.begin(), mAllApply.end());
}
 ...
 * @param[out] outWaveValues Vector of wave values to be appended to
 */
inline void Simulate::getWaveValues(std::vector<WaveValueSharedPtr>& outWaveValues) const {
 ...
 *
 */
template <typename _Action> inline void Simulate::applyOnAllPortListAlias(const _Action& action)
	throw (Error) {
	try {
 ...
 *
 */
template <typename _Action> inline void Simulate::applyOnAllWaveValues(const _Action& action)
	throw (Error) {
	try {
...
#endif // TORC_GENERIC_SIMULATE_HPP
