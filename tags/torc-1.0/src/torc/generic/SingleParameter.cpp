 ...
 */
SingleParameterSharedPtr SingleParameter::Factory::newSingleParameterPtr(const std::string& inName,
	const Value& inValue, const Unit& inUnit, const std::string& inOriginalName) throw (Error) {
	try {
...
void SingleParameter::accept(BaseVisitor& inoutVisitor) throw (Error) {
	try {
...
SingleParameter::SingleParameter() : Parameter(), Scalar<Parameter>() {}

SingleParameter::~SingleParameter() throw () {}

#ifdef GENOM_SERIALIZATION
template <class Archive> void SingleParameter::serialize(Archive& ar, unsigned int) {
...
template void SingleParameter::serialize<boost::archive::binary_oarchive>(
	boost::archive::binary_oarchive& ar, const unsigned int);

template void SingleParameter::serialize<boost::archive::binary_iarchive>(
