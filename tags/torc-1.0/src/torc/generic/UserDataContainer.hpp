...
#ifndef TORC_GENERIC_USERDATACONTAINER_HPP
#define TORC_GENERIC_USERDATACONTAINER_HPP
...
public:
	 ...
	 */
	inline void getUserData(std::list<std::string>& outUserData) const;
 ...
 * @param[out]  outUserData The list of all userData
 */
inline void UserDataContainer::getUserData(std::list<std::string>& outUserData) const {
	outUserData.insert(outUserData.end(), mUserData.begin(), mUserData.end());
	return;
}
...
#endif // TORC_GENERIC_USERDATACONTAINER_HPP
