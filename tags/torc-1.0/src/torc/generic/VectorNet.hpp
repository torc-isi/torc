...
#ifndef TORC_GENERIC_VECTORNET_HPP
#define TORC_GENERIC_VECTORNET_HPP
 ...
 * 
 * The VectorNet class represents a net array. Such objects in EDIF are declared using the
 * (net (array ...) ) syntax.
 */
class VectorNet : public Net, public Vector<Net, VectorNetBit, VectorNetBit::Factory, true> {
#ifdef GENOM_SERIALIZATION
...
public:
	...
	public:
		 ...
		 **/
		virtual VectorNetSharedPtr newVectorNetPtr(
...
#endif // TORC_GENERIC_VECTORNET_HPP
