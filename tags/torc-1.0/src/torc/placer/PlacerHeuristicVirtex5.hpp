...
#ifndef TORC_PLACER_PLACERHEURISTICVIRTEX5_HPP
#define TORC_PLACER_PLACERHEURISTICVIRTEX5_HPP
...
namespace placer {
	...
	class PlacerHeuristicVirtex5 : PlacerHeuristicBase {
	protected:
	//types
	...
	public:
		...
		PlacerHeuristicVirtex5(DDB& inDB, DesignSharedPtr inDesign) : mDB(inDB), mDesign(inDesign),
			mMovesPerTemperature(1), mIntialTemperature(1) {
...
#endif // TORC_PLACER_PLACERHEURISTICVIRTEX5_HPP
