...
/// \brief Unit test for the Spartan16Bitstream class.
BOOST_AUTO_TEST_CASE(bitstream_spartan16_bitstream) {
	...
	Spartan16Packet dummy(Spartan6::eSynchronizationDummy);
	Spartan16Packet nop(Spartan16Packet::makeHeader(Spartan6::ePacketType1, Spartan6::eOpcodeNOP, 
		0, 0));
	// dummy words
	bitstream.insert(bitstream.end(), 8, dummy);
	// sync
	bitstream.push_back(Spartan16Packet(Spartan6::eSynchronizationSync0));
	bitstream.push_back(Spartan16Packet(Spartan6::eSynchronizationSync1));
	// reset CRC command
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterCMD, Spartan6::eCommandRCRC));
	// nop command
	bitstream.push_back(nop);
	// FLR command
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterFLR, 0x0488));
	// configuration options register 1 
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterCOR1, 
	...
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterCOR2, 
		...
		0));
	// write the ID code
	bitstream.push_back(Spartan16Packet::makeType1Write32(Spartan6::eRegisterIDCODE, 0x04004093));
	// control register mask
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterMASK, 
	...
	// control register 
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterCTL, 
	...
	// SEU_OPT register 
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterSEU_OPT, 
	...
	// PWRDN_REG register 
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterPWRDN_REG, 
	...
	// CBC write command
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterCBC_REG, 0));
	// HC_OPT_REG register 
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterHC_OPT_REG, 
			Spartan6::makeSubfield(Spartan6::eRegisterHC_OPT_REG, "INIT", "0") |
		0x1f)); // No documentation for this Value
	// CWDT write command
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterCWDT, 0xffff));
	// PU_GTS write command
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterPU_GTS, 0x0005));
	// MFWR write command
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterMFWR, 0x0004));
	// PU_GWE write command
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterPU_GWE, 0x0100));
	// GENERAL2 write command
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterGENERAL2, 0x0000));
	// GENERAL3 write command
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterGENERAL3, 0x0000));
	// GENERAL4 write command
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterGENERAL4, 0x0000));
	// GENERAL5 write command
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterGENERAL5, 0x0000));
	// MODE_REG register 
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterMODE_REG, 
	...
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterEXP_SIGN, 0x1be2));
	// EXP_SIGN write command
	bitstream.push_back(Spartan16Packet::makeType1Write32(Spartan6::eRegisterRDBK_SIGN, 0x00000000));
	// nop command
	bitstream.push_back(nop);
	bitstream.push_back(nop);
	// frame address register
	bitstream.push_back(Spartan16Packet::makeType1Write32(Spartan6::eRegisterFARMAJ, 0x00000000));
	// enable configuration write command
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterCMD, Spartan6::eCommandWCFG));
	// write 0 bytes to FDRI (in preparation for type 2 write packet)
	//bitstream.push_back(Spartan16Packet::makeNullType2Write(Spartan6::eRegisterFDRI));
  ...
  //*(buffer + 0) = 0xabcd;
	...
	//bitstream.push_back(Spartan16Packet::makeType2Write(0x00061cca, Spartan6::eRegisterFDRI, buffer));
	bitstream.push_back(frameContents);
	// CRC Word? 
	uint16_t crcEndWord = 0x0015;
	bitstream.push_back(Spartan16Packet(crcEndWord));
	// CWDT write command
	size_t length = 15;
	uint16_t* buffer = new uint16_t[length];
	uint16_t* ptr = buffer + length - 1;
	while(ptr >= buffer) *ptr-- = 0x2000;
	bitstream.push_back(Spartan16Packet::makeType1Write(length, Spartan6::eRegisterCWDT, buffer));
	// 9 NOPs
	bitstream.insert(bitstream.end(), 9, nop);
	// restore command
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterCMD, 
	...
	// write the CRC value
	bitstream.push_back(Spartan16Packet::makeType1Write32(Spartan6::eRegisterCRC, 0x0002109d));
	// desync command
	bitstream.push_back(Spartan16Packet::makeType1Write(Spartan6::eRegisterCMD, 
