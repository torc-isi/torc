...
#ifndef TORC_GENERIC_FACTORYTYPE_HPP
#define TORC_GENERIC_FACTORYTYPE_HPP
 ...
 *
 * The FactoryType template acts as a placeholder for a virtual function create that can be
 * inherited by objects that want to create an object of an EOM type. This is typedeffed inside
 * individual classes to generate a nested typename for a factory that can be used to create an
 * object of that type. For example <i>Cell::Factory</i> can be used to create an object of type
 * Cell.
...
#endif // TORC_GENERIC_FACTORYTYPE_HPP
