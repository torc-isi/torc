...
#ifndef TORC_GENERIC_PORTREFCREATOR_HPP
#define TORC_GENERIC_PORTREFCREATOR_HPP
...
class PortRefCreator : public ScalarPort::Visitor, public VectorPort::Visitor,
...
public:
	...
	inline _ReturnType getReturnValue() const;

	PortRefCreator(const ObjectFactorySharedPtr& inFactory, const InstanceSharedPtr& inInstance,
...
template <typename _ReturnType> void PortRefCreator<_ReturnType>::visit(ScalarPort& port)
	throw (Error) {
	try {
...
template <typename _ReturnType> void PortRefCreator<_ReturnType>::visit(VectorPort& port)
	throw (Error) {
	try {
...
template <typename _ReturnType> inline _ReturnType PortRefCreator<_ReturnType>::getReturnValue()
	const {
	return mReturnValue;
}

template <typename _ReturnType> PortRefCreator<_ReturnType>::PortRefCreator(
	const ObjectFactorySharedPtr& inFactory, const InstanceSharedPtr& inInstance,
	const PortBundleReferenceSharedPtr& inBundle) :
	mFactory(inFactory), mInstance(inInstance), mBundle(inBundle), mReturnValue() {}

template <typename _ReturnType> PortRefCreator<_ReturnType>::~PortRefCreator() throw () {}

template <typename _ReturnType> void PortRefCreator<_ReturnType>::setupCreatedPort(
	const PortSharedPtr& port, const PortReferenceSharedPtr& inPortRef) throw (Error) {
	try {
...
#endif // TORC_GENERIC_PORTREFCREATOR_HPP
