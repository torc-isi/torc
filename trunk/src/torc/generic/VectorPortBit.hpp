...
#ifndef TORC_GENERIC_VECTORPORTBIT_HPP
#define TORC_GENERIC_VECTORPORTBIT_HPP
 ...
 * 
 * The VectorPortBit class represents a bit of an array port. Such objects cannot be created in
 * EDIF. They are automatically created when a particular member of an array is accessed using the
 * (member ...) syntax.
 */
class VectorPortBit : public Port, public VectorBit<Port> {
...
#endif // TORC_GENERIC_VECTORPORTBIT_HPP
