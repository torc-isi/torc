 ...
 */
void 
LogicValueAttributes::setStrongLogicValue(const LogicValueSharedPtr & inSource) throw() {
    mStrong = inSource;
}
 ...
 */
void 
LogicValueAttributes::setWeakLogicValue(const LogicValueSharedPtr & inSource) throw() {
    mWeak = inSource;
}
 ...
 */
void 
LogicValueAttributes::setVoltageMap(const Value::MiNoMax & value) throw() {
    mVoltageMap = value;
 ...
 */
void 
LogicValueAttributes::setCurrentMap(const Value::MiNoMax & value) throw() {
    mCurrentMap = value;
 ...
 */
void 
LogicValueAttributes::setBooleanMap(const Value::Boolean & value) throw() {
    mBooleanMap = value;
 ...
 */
void 
LogicValueAttributes::setCompoundLogicValues(
 ...
 */
void 
LogicValueAttributes::setDominatedLogicValues(
    const std::list< LogicValueSharedPtr > & inSource) throw(Error) {
    std::list< LogicValueSharedPtr >::const_iterator it = inSource.begin();
    for(; it != inSource.end(); it++ )
    {
 ...
 */
void 
LogicValueAttributes::setIsIsolated(const bool & inSource) throw() {
 ...
 */
void 
LogicValueAttributes::setLogicMaps(const std::list< LogicMap* > & inSource) throw() {
 ...
 */
void
LogicValueAttributes::addLogicMap(LogicMap* & inLogicMap) throw(Error) {
    if( !inLogicMap )
    {
        return;
    }
 ...
 */
void 
LogicValueAttributes::setResolvedLogicValues(
...
LogicValueAttributes::LogicValueAttributes()
    : mVoltageMap(),
    mIsVoltageMapSet( false ),
    mCurrentMap(),
    mIsCurrentMapSet( false ),
    mBooleanMap(),
    mIsBooleanMapSet( false ),
    mCompounds(),
    mWeak(),
    mStrong(),
    mDominates(),
...
LogicValueAttributes::operator=(
    const LogicValueAttributes & source) throw() {
    if( this != &source )
    {
        mVoltageMap         = source.mVoltageMap;
        mIsVoltageMapSet    = source.mIsVoltageMapSet;
